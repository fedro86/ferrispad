...
$SED_INPLACE "s|releases/download/[0-9][0-9.]*|releases/download/$NEW_VERSION|g" docs/js/main.js
$SED_INPLACE "s|FerrisPad-v[0-9][0-9.]*-|FerrisPad-v$NEW_VERSION-|g" docs/js/main.js
...
$SED_INPLACE "s|releases/download/[0-9][0-9.]*|releases/download/$NEW_VERSION|g" docs/index.html
$SED_INPLACE "s|FerrisPad-v[0-9][0-9.]*-|FerrisPad-v$NEW_VERSION-|g" docs/index.html

# 4. Update README.md (download URLs and version)
echo -e "${YELLOW}→${NC} Updating README.md..."
# Match version in tag (path segment) and in filename separately to preserve platform names
$SED_INPLACE "s|releases/download/[0-9][0-9.]*|releases/download/$NEW_VERSION|g" README.md
$SED_INPLACE "s|FerrisPad-v[0-9][0-9.]*-|FerrisPad-v$NEW_VERSION-|g" README.md
