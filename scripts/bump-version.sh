...
$SED_INPLACE "s|releases/download/[0-9][0-9.a-z-]*/FerrisPad-v[0-9][0-9.a-z-]*-|releases/download/$NEW_VERSION/FerrisPad-v$NEW_VERSION-|g" docs/js/main.js
...
$SED_INPLACE "s|releases/download/[0-9][0-9.a-z-]*/FerrisPad-v[0-9][0-9.a-z-]*-|releases/download/$NEW_VERSION/FerrisPad-v$NEW_VERSION-|g" docs/index.html

# 4. Update README.md (download URLs and version)
echo -e "${YELLOW}→${NC} Updating README.md..."
$SED_INPLACE "s|releases/download/[0-9][0-9.a-z-]*/FerrisPad-v[0-9][0-9.a-z-]*-|releases/download/$NEW_VERSION/FerrisPad-v$NEW_VERSION-|g" README.md
