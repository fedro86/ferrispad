...
function updateDownloadButton() {
    ...
    const osConfig = {
        'windows': {
            name: 'Windows',
            url: 'https://github.com/fedro86/ferrispad/releases/download/0.1.4/FerrisPad-v0.1.4-windows-x64.zip'
        },
        'macos': {
            name: 'macOS',
        ...
        'linux': {
            name: 'Ubuntu/Linux',
            url: 'https://github.com/fedro86/ferrispad/releases/download/0.1.4/FerrisPad-v0.1.4-ubuntu-amd64.deb'
        }
    };
